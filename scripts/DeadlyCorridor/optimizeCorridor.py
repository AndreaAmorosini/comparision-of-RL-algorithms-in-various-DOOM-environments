...
N_ENVS = 1
FRAME_SKIP = 4
N_TRIALS = 20 #100 PPO/ 1 DQN/ 50 A2C
...
def optimizeParams(modelName, trial):
    ...
    if MODEL == "PPO":
        ...
        config = {
            ...
            # "ent_coef": ENT_COEF,
            "max_grad_norm": trial.suggest_categorical("max_grad_norm", [0.3, 0.5, 0.6, 0.7, 0.8, 0.9, 1.0, 2.0, 5.0]),
        }
...
if __name__ == "__main__":
    study = optuna.create_study(direction='maximize',
                                ...
                                storage="sqlite:///" + DB_DIR + ".db", load_if_exists=True)
